# write_import_vba.py - UTF-8 BOM で import-vba.ps1 を生成する
# .dcm はスキップ（今回の改修対象は .bas のみ）

OUT = 'c:/Users/1784/claude/VBA/Excel/GitAdminVBA/temp/import-vba.ps1'
